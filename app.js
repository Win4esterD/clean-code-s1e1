...
var incompleteTaskHolder=document.querySelector(".pending");//ul of #incompleteTasks
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.children[1].className = "task label completed"
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.children[1].className = "task label";
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
